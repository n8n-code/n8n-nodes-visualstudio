...
export class VisualstudioApi implements ICredentialType {
	name = 'N8nDevVisualstudioApi';

	displayName = 'visualstudio API';

	icon: Icon = { light: 'file:../nodes/Visualstudio/visualstudio.svg', dark: 'file:../nodes/Visualstudio/visualstudio.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'https://online.visualstudio.com',
			required: true,
			placeholder: 'https://online.visualstudio.com',
			description: 'The base URL of your visualstudio API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
